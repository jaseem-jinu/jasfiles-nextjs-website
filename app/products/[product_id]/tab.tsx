...
const tabs = [
    {
        ...
        content: (
            <div className='border-2 border-blue-400 rounded-lg p-4'>
                <h2 className='text-3xl text-blue-600'>Title Test 1</h2>
                <p>
    ...
    },
    {
        ...
        content: (
            <div className='border-2 border-blue-400 rounded-lg p-4'>
                <h2 className='text-3xl text-blue-600'>Title Test 2</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
    ...
    },
    {
        ...
        content: (
            <div className='border-2 border-blue-400 rounded-lg p-4'>
                <h2 className='text-3xl text-blue-600'>Title Test 3</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
                    aperiam asperiores doloribus velit dolore magnam ex consectetur fugit
                    earum illum qui similique architecto dolorum, minima enim quidem
    ...
    },
    {
        ...
        content: (
            <div className='border-2 border-blue-400 rounded-lg p-4'>
                <h2 className='text-3xl text-blue-600'>Title Test 4</h2>
                <p>
